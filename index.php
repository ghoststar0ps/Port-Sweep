					...
					<div class="panel-body">
						<div class="form-inline">
						  <div class="form-group">
							  <label class="sr-only" for="server">IP Address</label>
							  <input style="width:195px;" class="form-control" id="server" name="server" placeholder="IP Address" value="<?php echo RealIpAddress(); ?>">
						  </div>
						  <div class="form-group">
						  ...
						  <input type="submit" class="btn btn-primary" id="myButton" value=" Check port" />
						  ...
						  <div style="margin:10px 0 0 0;" class="lblBtn">
							...
							<span id="quick" class="label label-success" port="22">Quick Scan[15 Port]</span>
							<span id="long" class="label label-warning" port="3389">Long Scan[36 Port]</span>
						  </div>
